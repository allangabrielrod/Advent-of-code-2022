...
const elvesCaloriesData = fs.readFileSync("input.txt").toString("utf-8");

const elvesCalories = [];

let currentElfCalories = 0;
elvesCaloriesData.split("\n").forEach((item) => {
  if (!!item) {
...
const orderedElvesCalories = elvesCalories.sort((a, b) => b - a);
const top3MostCaloriesSum = orderedElvesCalories
  .slice(0, 3)
  .reduce(
    (accumulator, currentElfCalories) => accumulator + currentElfCalories
  );

console.log("Most Calories:", orderedElvesCalories[0]);
console.log("Top 3 sum:", top3MostCaloriesSum);
